        ...
        <v-form ref="form" v-model="valid" validation>
          <v-container grid-list-md>
            <v-layout wrap>
              ...
              <v-flex xs5 md5 lg5>
                <!--значения из пикера даты нужно передавать с помощью state, иначе никак не передать в state предназначенный для добавления записи в БД-->
                <rf-date-picker></rf-date-picker>
              </v-flex>

              <v-flex xs12 md12 lg12 pb-4>
                <!--значения из аутокомплита нужно передавать с помощью state, иначе никак не передать в state предназначенный для добавления записи в БД
                но вместе с тем нужно добавить отдельный excel для хранения значений аутокомплита, либо добавить отдельную таблицу в БД-->
